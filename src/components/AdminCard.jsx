...
const driver_total =
  "http://ec2-54-82-25-173.compute-1.amazonaws.com:8000/api/users/all-drivers";
const passenger_total =
  "http://ec2-54-82-25-173.compute-1.amazonaws.com:8000/api/users/all-passengers";
const AdminCard = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((error) => {
        console.error("There was an error fetching the total drivers!", error);
      });
  }, []);
  ...
  useEffect(() => {
    axios
      ...
      .catch((error) => {
        console.error(
          "There was an error fetching the total Passengers!",
          error
        );
      });
  }, []);
  ...
  return (
    <div className="grid grid-cols-1 gap-8 px-4 mt-8 sm:grid-cols-4 sm:px-8">
      ...
      <div className="flex items-center bg-white rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-105">
        ...
        <div className="px-6 py-4">
          <h3 className="text-sm font-medium text-gray-700">Total Booking</h3>
